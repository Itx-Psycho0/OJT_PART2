...
// Share Button sub-component to isolate dialog state
  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-2 rounded-full bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 text-sm font-medium transition-colors shadow-sm"
      >
        <svg
